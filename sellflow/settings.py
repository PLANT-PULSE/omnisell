"""
Django settings for SellFlow project.
"""
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-sellflow-dev-key-change-in-production')
...
SOCIAL_API_KEYS = {
    ...
    'whatsapp': os.environ.get('WHATSAPP_API_KEY', ''),
}
